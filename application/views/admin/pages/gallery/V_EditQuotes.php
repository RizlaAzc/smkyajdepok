                ...
                <div class="container-fluid">
                    ...
                    <section style="background-color: #eee;">
                        <div class="container py-4">
                            ...
                            <?= form_open_multipart('admin/pages/gallery/quotes/fungsi_edit'); ?>
                            <div class="row">
                            <div class="col-lg-4">
                                <div class="card mb-4">
                                <div class="card-body text-center">
                                    <img src="<?= base_url('assets/admin/img/pages/quotes/') .$quotes_detail->gambar ?>" alt="avatar"
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" type="hidden" name="id" value="<?= $quotes_detail->id ?>">
                                        <input class="form-control" type="text" name="nama" value="<?= $quotes_detail->nama ?>">
                                    </div>
                                    </div>
                                    <hr>
                                    <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" type="text" name="jabatan" value="<?= $quotes_detail->jabatan ?>">
                                    </div>
                                    </div>
                                    <!-- <hr>
                                    <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea class="form-control" rows="4" name="quotes"><?= $quotes_detail->quotes ?></textarea>
                                    </div>
                                    </div>
                                    <hr>
                                    <div class="row">
