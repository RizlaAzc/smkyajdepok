                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item"><a href="<?= base_url('admin/carousel') ?>">Carousel</a></li>
                    ...
                    <section style="background-color: #eee;">
                        <div class="container py-4">
                            ...
                            <?= form_open_multipart('admin/pages/carousel/fungsi_edit'); ?>
                            <div class="row">
                            <div class="col-lg-4">
                                <div class="card mb-4">
                                <div class="card-body text-center">
                                    <img src="<?= base_url('assets/admin/img/pages/carousel/') .$carousel_detail->gambar ?>" alt="avatar"
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" type="hidden" name="id" value="<?= $carousel_detail->id ?>">
                                        <input class="form-control" type="text" name="subjek" value="<?= $carousel_detail->subjek ?>">
                                    </div>
                                    </div>
                                    <!-- <hr>
                                    <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea class="form-control" rows="4" name="deskripsi"><?= $carousel_detail->deskripsi ?></textarea>
                                    </div>
                                    </div>
                                    <hr>
                                    <div class="row">
