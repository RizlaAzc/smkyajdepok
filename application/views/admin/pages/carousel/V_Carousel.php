                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center m-5" style="vertical-align: middle;"><a href="" class="d-none d-sm-inline-block btn btn-sm btn-primary
                                             shadow-sm mr-1" data-toggle="modal" data-target="#logoutModal"><i class="fas fa-pen fa-sm text-white-50"></i></a><a href="" class="d-none d-sm-inline-block btn btn-sm btn-danger
                                             shadow-sm ml-1" data-toggle="modal" data-target="#logoutModal"><i class="fas fa-trash fa-sm text-white-50"></i></a></td>
                                        </tr>
                                        <?php
                                        }
                                        ?>
