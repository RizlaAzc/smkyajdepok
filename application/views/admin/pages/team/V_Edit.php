                ...
                <div class="container-fluid">
                    ...
                    <section style="background-color: #eee;">
                        <div class="container py-4">
                            ...
                            <?= form_open_multipart('admin/pages/team/fungsi_edit'); ?>
                            <div class="row">
                            <div class="col-lg-4">
                                <div class="card mb-4">
                                <div class="card-body text-center">
                                    <img src="<?= base_url('assets/admin/img/pages/team/') .$team_detail->gambar ?>" alt="avatar"
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" type="hidden" name="id" value="<?= $team_detail->id ?>">
                                        <input class="form-control" type="text" name="nama" value="<?= $team_detail->nama ?>">
                                    </div>
                                    </div>
                                    <hr>
                                    <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" type="text" name="jabatan" value="<?= $team_detail->jabatan ?>">
                                    </div>
                                    </div>
                                    <!-- <hr>
                                    <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea class="form-control" rows="4" name="jabatan"><?= $team_detail->jabatan ?></textarea>
                                    </div>
                                    </div> -->
                                    <hr>
                                    <div class="row">
