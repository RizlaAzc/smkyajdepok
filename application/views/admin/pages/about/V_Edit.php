                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item"><a href="<?= base_url('admin/pages/about/about') ?>">About</a></li>
                        ...
                        <div class="container py-4">
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" type="text" name="deskripsi" value="<?= $about_detail->deskripsi ?>">
                                    </div>
                                    </div>
                                    <hr>
                                    <div class="row">
