                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center m-5" style="vertical-align: middle;"><a href="<?= base_url('admin/pages/quotes/fungsi_hapus/') . $quotes->id ?>" class="d-none d-sm-inline-block btn btn-sm btn-danger
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?= form_open_multipart('admin/pages/quotes/fungsi_tambah'); ?>
