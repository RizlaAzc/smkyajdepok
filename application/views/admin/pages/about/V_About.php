                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="vertical-align: middle;"><?= $about->subjek ?></td>
                                            <td style="vertical-align: middle;"><?= $about->deskripsi ?></td>
                                            <td class="text-center" style="vertical-align: middle;"><img src="<?= base_url('assets/admin/img/pages/about/') ?><?= $about->gambar ?>" width="75"></td>
                                            <td class="text-center m-5" style="vertical-align: middle;"><a href="<?= base_url('admin/pages/about/about/edit/') . $about->id ?>" class="d-none d-sm-inline-block btn btn-sm btn-primary
