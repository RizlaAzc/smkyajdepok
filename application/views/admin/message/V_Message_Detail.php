                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Message <?= $pesan_detail->nama ?></h1>
                        <ol class="breadcrumb mb-0">
                            <!-- <li class="breadcrumb-item"><a href="#">Home</a></li> -->
                            <li class="breadcrumb-item"><a href="<?= base_url('admin/message') ?>">Message</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Message <?= $pesan_detail->nama ?></li>
                        </ol>   
                    ...
                    <section style="background-color: #eee;">
                        <div class="container py-4">
                            ...
                            <a href="<?= base_url('admin/message') ?>" class="btn btn-primary">Confirm</a>
                                <!-- <div class="row">
                                <div class="col-md-6">
