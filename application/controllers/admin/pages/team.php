...
class team extends CI_Controller {
	...
	public function index()
	{
        ...
        $data['team'] = $this->model_team->getDatateam();
		...
		$this->load->view('admin/pages/about/V_Team', $data);
    ...
    public function fungsi_tambah()
    {
        ...
        $this->model_team->insertDatateam($ArrInsert);
    ...
    public function fungsi_hapus($id)
    {
        ...
        $this->model_team->hapusDatateam($id);
